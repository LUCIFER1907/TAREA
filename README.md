...
<table>
    ...
    <tr>
        <th>Task 03: <br> -Fixed the Slider. <br> -Add favicon to the website, extract the logo images. <br> -Creating the Folders courses and Login to write the URLS. <br> -Write descriptions and keywords on the header of each html file. <br> -Add schema.org annotations to the webpages. </th>
        <th>Nour elhouda Benaida</th>
    </tr>
    <tr>
    ...
    <tr>
        <th>Task 02: <br> - Checked and fixed pages if usable without CSS <br> - Checked Font size on all sites <br> - Checked if used the correct color contrast foreground/background <br> - Provided textual alternatives for non-textual content <br> - Checked accessibility with Lighthouse tool, all pages over 95% <br> 
        <th>Gregi Cami</th>
    </tr>
</table>	
